...
#ifndef ANTARES_COCOA_ANTARES_SETTINGS_CONTROLLER_H_
#define ANTARES_COCOA_ANTARES_SETTINGS_CONTROLLER_H_

#include <Cocoa/Cocoa.h>

@interface AntaresSettingsController : NSObject {
    id _target;
    SEL _selector;
...
#endif  // ANTARES_COCOA_ANTARES_SETTINGS_CONTROLLER_H_
