...
short kDefaultKeyMap[kKeyControlDataNum] = {
  0x5c, 0x58, 0x57, 0x59, 0x3b, 0x38, 0x32, 0x31, 0x48, 0x52,
  0x4c, 0x39, 0x3c, 0x46, 0x4f, 0x7f, 0x7e, 0x7d, 0x7c, 0x65,
  0x66, 0x6e, 0x68, 0x70, 0x73, 0x74, 0x75, 0x34, 0x7b, 0x79,
  0x64, 0x77, 0x61, 0x62, 0x13, 0x14, 0x15, 0x16, 0x18, 0x17,
  0x1b, 0x1d, 0x1a, 0x1e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
const char kDefaultPlayerName[] = "\pAdmiral Grammaticus";
const char kDefaultGameName[] = "\pAres Game";
...
//      if (((preferencesDataType *)(*gAresGlobal->gPreferencesData))->version <= 0x00000011)
    ...
    if (( oserr != noErr) || ( gAresGlobal->gPreferencesData == nil))
    {
        ...
        gAresGlobal->gPreferencesData = new char*((char*)new preferencesDataType);
        oserr = ResError();
